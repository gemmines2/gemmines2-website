...
const PRODUCTS = [
  ...
  },
  {
    ...
    "status": "active",
    "rare": true,
    "description": "Behold this stunning 2.93 carat heated Padparadscha sapphire from the world-famous gem mines of Sri Lanka (Ceylon)ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂthe classic origin for the finest examples of this coveted variety. Derived from the Sinhalese \"padmaraga\" meaning \"lotus color,\" this gem captivates with its rare delicate pinkish-orange to orangey-pink hue, evoking the soft glow of a lotus blossom at sunset or a tropical dawnÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂperfectly balanced between warm orange and romantic pink tones. Professionally heated using industry-standard methods, it achieves enhanced color saturation, exceptional uniformity, and a beautiful, bright vitreous luster with lively brilliance and subtle inner glow under all lighting. High transparency, eye-clean clarity, and minimal inclusions highlight its superior fire and sparkle. Padparadscha sapphires are among the rarest gems on earth, highly prized by collectors and jewelers for their poetic elegance and scarcity. This treated stone offers outstanding beauty and valueÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂideal for exquisite custom rings, pendants, earrings, or as a luxurious heirloom/investment piece. A sophisticated alternative to September birthstones. Full authenticity details available (lab certification recommended). Embrace the timeless allure of Ceylon's legendary \"lotus sapphire\"! #PadparadschaSapphire #HeatedPadparadscha #SriLankanSapphire #CeylonSapphire #Padparadscha #PinkOrangeSapphire #LotusSapphire #SunsetSapphire #RareGemstone #NaturalSapphire #HeatedSapphire #FineGems #GemstoneJewelry #LooseSapphire #SeptemberBirthstone #LuxuryGems #SapphireLovers #CeylonGems #InvestmentGem #GemCollecting",
    "gemType": "Sapphire",
    "images": [
